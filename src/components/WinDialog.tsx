...
export default function WinDialog( { isOpen , onOpen, onClose, noOfTries }: {isOpen:boolean,onOpen: ()=>void,onClose:()=>void,noOfTries:number}){
    return <AlertDialog isOpen={isOpen} onClose={onClose} motionPreset='slideInBottom' isCentered size='xl' leastDestructiveRef={undefined}>
    <AlertDialogOverlay />
    <AlertDialogContent>
